...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  @ExceptionHandler(cl.exercise.encryption.exception.ResourceException.class)
  public ResponseEntity<?> handleResponseExceptions(
      cl.exercise.encryption.exception.ResourceException ex, WebRequest request)
  ...
  private ResponseEntity<?> getResponseEntity(Exception ex, WebRequest request)
    ...
    ErrorDetails error =
        ErrorDetails.builder()
            ...
            .build();
    cl.exercise.encryption.exception.ErrorList errors =
        cl.exercise.encryption.exception.ErrorList.builder().errors(Arrays.asList(error)).build();
